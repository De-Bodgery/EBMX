...
#define MCCONF_L_CURRENT_MAX			900.0	// Current limit in Amperes (Upper)
#endif
...
#define MCCONF_L_MAX_ABS_CURRENT		1200.0	// The maximum absolute current above which a fault is generated
#endif
...
#define MCCONF_L_RPM_START				0.65		// Fraction of full speed where RPM current limiting starts
#endif
...
#define MCCONF_L_CURR_MAX_RPM_FBRAKE	3000		// Maximum electrical RPM to use full brake at
#endif
#ifndef MCCONF_L_CURR_MAX_RPM_FBRAKE_CC
#define MCCONF_L_CURR_MAX_RPM_FBRAKE_CC	4500	// Maximum electrical RPM to use full brake at with current control
#endif
...
#endif
#ifndef KMCCONF_L_LIM_TEMP_MOTOR_START
#define KMCCONF_L_LIM_TEMP_MOTOR_START	125.0	// MOTOR temperature where current limiting should begin
#endif
#ifndef KMCCONF_L_LIM_TEMP_MOTOR_END
#define KMCCONF_L_LIM_TEMP_MOTOR_END		140.0	// MOTOR temperature where everything should be shut off
#endif
...
// FOC
#ifndef KMCCONF_FOC_CURRENT_KP
#define KMCCONF_FOC_CURRENT_KP			0.05
#endif
#ifndef KMCCONF_FOC_CURRENT_KI
#define KMCCONF_FOC_CURRENT_KI			1
#endif
...
#define MCCONF_FOC_ENCODER_OFFSET		126.53
#endif
#ifndef MCCONF_FOC_ENCODER_RATIO
#define MCCONF_FOC_ENCODER_RATIO		5.0
#endif
#ifndef KMCCONF_FOC_SENSOR_MODE
#define KMCCONF_FOC_SENSOR_MODE			FOC_SENSOR_MODE_HALL
#endif
...
#endif
#ifndef KMCCONF_FOC_MOTOR_L
#define KMCCONF_FOC_MOTOR_L				3.6e-05
#endif
#ifndef KMCCONF_FOC_MOTOR_R
#define KMCCONF_FOC_MOTOR_R				0.0035
#endif
#ifndef KMCCONF_FOC_MOTOR_FLUX_LINKAGE
#define KMCCONF_FOC_MOTOR_FLUX_LINKAGE	0.01400
#endif
#ifndef KMCCONF_FOC_MOTOR_LD_LQ_DIFF
#define KMCCONF_FOC_MOTOR_LD_LQ_DIFF		0
#endif
#ifndef KMCCONF_FOC_OBSERVER_GAIN
#define KMCCONF_FOC_OBSERVER_GAIN		1e+06		// Can be something like 600 / L
#endif
#ifndef KMCCONF_FOC_OBSERVER_GAIN_SLOW
#define KMCCONF_FOC_OBSERVER_GAIN_SLOW	0.3	// Observer gain scale at minimum duty cycle
#endif
#ifndef KMCCONF_FOC_OBSERVER_OFFSET
#define KMCCONF_FOC_OBSERVER_OFFSET		-0.5	// Observer offset in timer update cycles
#endif
...
#endif
#ifndef KMCCONF_FOC_OPENLOOP_RPM
#define KMCCONF_FOC_OPENLOOP_RPM			0.0	// Openloop RPM (sensorless low speed or when finding index pulse)
#endif
...
#define MCCONF_FOC_D_GAIN_SCALE_START	0.6		// Start reducing D axis current controller gain at this modulation
#endif
...
#endif
#ifndef KMCCONF_FOC_HALL_TAB_0
#define KMCCONF_FOC_HALL_TAB_0			255
#endif
#ifndef KMCCONF_FOC_HALL_TAB_1
#define KMCCONF_FOC_HALL_TAB_1		    172
#endif
#ifndef KMCCONF_FOC_HALL_TAB_2
#define KMCCONF_FOC_HALL_TAB_2			91
#endif
#ifndef KMCCONF_FOC_HALL_TAB_3
#define KMCCONF_FOC_HALL_TAB_3			132
#endif
#ifndef KMCCONF_FOC_HALL_TAB_4
#define KMCCONF_FOC_HALL_TAB_4			36
#endif
#ifndef KMCCONF_FOC_HALL_TAB_5
#define KMCCONF_FOC_HALL_TAB_5		    3
#endif
#ifndef KMCCONF_FOC_HALL_TAB_6
#define KMCCONF_FOC_HALL_TAB_6			59
#endif
#ifndef KMCCONF_FOC_HALL_TAB_7
#define KMCCONF_FOC_HALL_TAB_7			255
#endif
#ifndef KMCCONF_FOC_HALL_INTERP_ERPM
#define KMCCONF_FOC_HALL_INTERP_ERPM		500		// Do not interpolate hall sensors below this ERPM
#endif
#ifndef KMCCONF_FOC_SL_ERPM
#define KMCCONF_FOC_SL_ERPM				5000.0	// ERPM above which only the observer is used
#endif
...
#endif
#ifndef KMCCONF_FOC_SAT_COMP
#define KMCCONF_FOC_SAT_COMP				0.15	// Stator saturation compensation
#endif
...
#endif
#ifndef KMCCONF_FOC_MTPA_MODE
#define KMCCONF_FOC_MTPA_MODE				MTPA_MODE_IQ_TARGET // Maximum torque per amp (MTPA) algorithm mode
#endif
#ifndef MCCONF_FOC_FW_CURRENT_MAX
#define MCCONF_FOC_FW_CURRENT_MAX		0.0 // Maximum field weakening current
#endif
#ifndef KMCCONF_FOC_FW_DUTY_START
#define KMCCONF_FOC_FW_DUTY_START		0.9 // Start field weakening at this fraction of max duty cycle
#endif
#ifndef KMCCONF_FOC_FW_RAMP_TIME
#define KMCCONF_FOC_FW_RAMP_TIME			0.2 // Ramp time for field weakening current
#endif
#ifndef KMCCONF_FOC_FW_Q_CURRENT_FACTOR
#define KMCCONF_FOC_FW_Q_CURRENT_FACTOR	0 // Factor of the FW-current to feed to the Q-axis to slow motor down when setting 0 current
#endif
...
#define MCCONF_M_ENCODER_COUNTS			4096	// The number of encoder counts
#endif
...
#endif
#ifndef KMCCONF_M_SENSOR_PORT_MODE
#define KMCCONF_M_SENSOR_PORT_MODE		SENSOR_PORT_MODE_HALL // The mode of the hall_encoder port
#endif
#ifndef KMCCONF_M_INVERT_DIRECTION
#define KMCCONF_M_INVERT_DIRECTION		true // Invert the motor direction
#endif
...
#endif
#ifndef KMCCONF_M_MOTOR_TEMP_SENS_TYPE
#define KMCCONF_M_MOTOR_TEMP_SENS_TYPE	TEMP_SENSOR_KTY84_130 // Motor temperature sensor type
#endif
...
// Setup Info
#ifndef KMCCONF_SI_MOTOR_POLES
#define KMCCONF_SI_MOTOR_POLES			8// Motor pole count
#endif
...
#endif
#ifndef KMCCONF_SI_MOTOR_NL_CURRENT
#define KMCCONF_SI_MOTOR_NL_CURRENT		800 // Motor MAX current
#endif
