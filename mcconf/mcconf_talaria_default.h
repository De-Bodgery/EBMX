...
#define  MCCONF_L_CURRENT_MAX			600.0	// Current limit in Amperes (Upper)
#endif
#ifndef MCCONF_L_CURRENT_MIN
#define MCCONF_L_CURRENT_MIN			-400.0	// Current limit in Amperes (Lower)
#endif
...
#endif
#ifndef TMCCONF_L_LIM_TEMP_MOTOR_START
#define TMCCONF_L_LIM_TEMP_MOTOR_START	120	// MOTOR temperature where current limiting should begin
#endif
#ifndef TMCCONF_L_LIM_TEMP_MOTOR_END
#define TMCCONF_L_LIM_TEMP_MOTOR_END		130.0	// MOTOR temperature where everything should be shut off
#endif
...
#endif
#ifndef TMCCONF_L_WATT_MAX
#define TMCCONF_L_WATT_MAX				1500000.0	// Maximum wattage output
#endif
#ifndef TMCCONF_L_WATT_MIN
#define TMCCONF_L_WATT_MIN				-1500000.0	// Minimum wattage output (braking)
#endif
...
// FOC
#ifndef TMCCONF_FOC_CURRENT_KP
#define TMCCONF_FOC_CURRENT_KP			0.1
#endif
#ifndef TMCCONF_FOC_CURRENT_KI
#define TMCCONF_FOC_CURRENT_KI			5
#endif
...
#endif
#ifndef TMCCONF_FOC_ENCODER_INVERTED
#define TMCCONF_FOC_ENCODER_INVERTED		true
#endif
#ifndef TMCCONF_FOC_ENCODER_OFFSET
#define TMCCONF_FOC_ENCODER_OFFSET		126.53
#endif
#ifndef TMCCONF_FOC_ENCODER_RATIO
#define TMCCONF_FOC_ENCODER_RATIO		5.0
#endif
#ifndef TMCCONF_FOC_SENSOR_MODE
#define TMCCONF_FOC_SENSOR_MODE			FOC_SENSOR_MODE_ENCODER
#endif
...
#endif
#ifndef TMCCONF_FOC_MOTOR_L
#define TMCCONF_FOC_MOTOR_L				0.000038
#endif
#ifndef TMCCONF_FOC_MOTOR_R
#define TMCCONF_FOC_MOTOR_R				0.0050
#endif
#ifndef TMCCONF_FOC_MOTOR_FLUX_LINKAGE
#define TMCCONF_FOC_MOTOR_FLUX_LINKAGE	0.01200
#endif
#ifndef TMCCONF_FOC_MOTOR_LD_LQ_DIFF
#define TMCCONF_FOC_MOTOR_LD_LQ_DIFF		0.000015
#endif
#ifndef TMCCONF_FOC_OBSERVER_GAIN
#define TMCCONF_FOC_OBSERVER_GAIN		0.10e7		// Can be something like 600 / L
#endif
#ifndef MCCONF_FOC_OBSERVER_GAIN_SLOW
#define MCCONF_FOC_OBSERVER_GAIN_SLOW	0.05	// Observer gain scale at minimum duty cycle
#endif
#ifndef TMCCONF_FOC_OBSERVER_OFFSET
#define TMCCONF_FOC_OBSERVER_OFFSET		-1.5	// Observer offset in timer update cycles
#endif
...
#define MCCONF_FOC_OPENLOOP_RPM			0.0	// Openloop RPM (sensorless low speed or when finding index pulse)
#endif
...
#endif
#ifndef TMCCONF_FOC_SL_ERPM
#define TMCCONF_FOC_SL_ERPM				50000.0	// ERPM above which only the observer is used
#endif
...
#endif
#ifndef TMCCONF_M_ENCODER_COUNTS
#define TMCCONF_M_ENCODER_COUNTS			4096	// The number of encoder counts
#endif
...
#endif
#ifndef TMCCONF_M_SENSOR_PORT_MODE
#define TMCCONF_M_SENSOR_PORT_MODE		SENSOR_PORT_MODE_ABI // The mode of the hall_encoder port
#endif
#ifndef TMCCONF_M_INVERT_DIRECTION
#define TMCCONF_M_INVERT_DIRECTION		false // Invert the motor direction
#endif
...
#endif
#ifndef TMCCONF_M_NTC_MOTOR_BETA
#define TMCCONF_M_NTC_MOTOR_BETA			3380.0 // Beta value for motor termistor
#endif
#ifndef MCCONF_M_OUT_AUX_MODE
#define MCCONF_M_OUT_AUX_MODE			OUT_AUX_MODE_OFF // Auxiliary output mode
#endif
#ifndef TMCCONF_M_MOTOR_TEMP_SENS_TYPE
#define TMCCONF_M_MOTOR_TEMP_SENS_TYPE	TEMP_SENSOR_KTY84_130 // Motor temperature sensor type
#endif
...
#endif
#ifndef TMCCONF_SI_MOTOR_NL_CURRENT
#define TMCCONF_SI_MOTOR_NL_CURRENT		600 // Motor current
#endif
