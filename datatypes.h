...
// ADC control types
typedef enum {
	ADC_CTRL_TYPE_NONE = 0, ADC_CTRL_TYPE_CURRENT_THROTTLE

} adc_control_type;
typedef enum {
	REGEN_CTRL_TYPE_NONE = 0,
	REGEN_CTRL_TYPE_REGEN,
	REGEN_CTRL_TYPE_REGEN_AS_THROTTLE,
...
typedef enum {
	CAN_MODE_VESC = 0, CAN_MODE_UAVCAN, CAN_MODE_COMM_BRIDGE
} CAN_MODE;
