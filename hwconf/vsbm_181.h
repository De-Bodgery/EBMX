...
//#ifdef PHOTON
#define HW_NAME		"X6                  "//need add space to seperate serial.no
...
#define TILT_IO     GPIOB //Digital Input 3
#define TILT_PIN    5

#define BUTTON_SWITCH_IO     GPIOB //Button/Switch
#define BUTTON_SWITCH_PIN    5

#define ENCODER_ZERO_IO      GPIOB //Zero identifier
#define ENCODER_ZERO_PIN     5

#define P12V_OUT1_IO     GPIOB //Digital Output 1, Pushpull
#define P12V_OUT1_PIN    5

#define P12V_OUT2_IO     GPIOB //Digital Output 2
#define P12V_OUT2_PIN    5

#define P12V_OUT3_IO     GPIOB //Digital Output 3
#define P12V_OUT3_PIN    5

#define P12V_OUT4_IO     GPIOB //Digital Output 4
#define P12V_OUT4_PIN    5
...
#define CURRENT_SHUNT_RES		0.0002//0.0005/3//
//#endif
...
//try x1pro now
#if X1PRO
#define NTC_RES_MOTOR(adc_val)	(((4095.0 *2307*1.03) / adc_val) - 2307 )// Motor temp sensor on high side
#else
//stealth
#define NTC_RES_MOTOR(adc_val)	(((4095.0 *272*1.03) / adc_val) - 272 )// Motor temp sensor on high side
#endif

#ifdef HW75_300_VEDDER_FIRST_PCB
#define NTC_TEMP_MOTOR(beta)	(-20)
#else
#define NTC_TEMP_MOTOR(beta)	(1.0 / ((logf(NTC_RES_MOTOR(ADC_Value[ADC_IND_TEMP_MOTOR]/1.6666) / 5000) / beta) + (1.0 / 298.15)) - 273.15)
#endif
