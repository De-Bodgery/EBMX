...
//#ifdef PHOTON
#define HW_NAME		"X12 test  3.2       "//need add space to seperate serial.no
...
#define ENCODER_SIN_VOLTS				ADC_VOLTS_SINCOS(0)
#define ENCODER_COS_VOLTS				ADC_VOLTS_SINCOS(0)
...
#define NTC_RES_MOTOR(adc_val)	(((4095.0 *10000*1.03) / adc_val) - 10000 )// Motor temp sensor on low side
