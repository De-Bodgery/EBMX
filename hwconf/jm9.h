...
#define BRAKE_IO    GPIOB //Digital Input 1
#define BRAKE_PIN   12

#define STAND_IO    GPIOB //Digital Input 2
#define STAND_PIN   5

#define TILT_IO     GPIOD //Digital Input 3
#define TILT_PIN    2

#define BUTTON_SWITCH_IO     GPIOC //Button/Switch
#define BUTTON_SWITCH_PIN    12

#define ENCODER_ZERO_IO      GPIOC //Zero identifier
#define ENCODER_ZERO_PIN     13

#define P12V_OUT1_IO     GPIOA //Digital Output 1, Pushpull
#define P12V_OUT1_PIN    11

#define P12V_OUT2_IO     GPIOA //Digital Output 2
#define P12V_OUT2_PIN    12

#define P12V_OUT3_IO     GPIOB //Digital Output 3
#define P12V_OUT3_PIN    3

#define P12V_OUT4_IO     GPIOB //Digital Output 4
#define P12V_OUT4_PIN    4

// Sin/Cos Encoder signals
#define ENCODER_SIN_VOLTS				ADC_VOLTS_SINCOS(ADC_IND_SIN)
#define ENCODER_COS_VOLTS				ADC_VOLTS_SINCOS(ADC_IND_COS)
...
#define PHASE_FILTER_GPIO		GPIOC //empty
...
#else
#define ADC_IND_TEMP_MOS		8
#define ADC_IND_TEMP_MOS_2      13
#define ADC_IND_TEMP_MOS_3		16
#endif
#define ADC_IND_TEMP_MOTOR		9
#define ADC_IND_VREFINT			12
#define ADC_IND_SIN			    10//PC5
#define ADC_IND_COS	            15//PA6
...
//#endifq
//#ifndef VIN_R2
#define VIN_R2					2310.0
//#endif
//#ifndef CURRENT_AMP_GAIN
#define CURRENT_AMP_GAIN		9.4
//9.4 on new pcb  slim no pad, 700A accurate, 800A become 880A
//810A become 900A
//#endif
...
#else
#define NTC_TEMP_MOTOR(beta)	(1.0 / ((logf(NTC_RES_MOTOR(ADC_Value[ADC_IND_TEMP_MOTOR]) / 5000) / beta) + (1.0 / 298.15)) - 273.15)
#endif
...
#define ADC_VOLTS_SINCOS(ch)			((float)ADC_Value[ch] / 4096.0 * 5.55)
...
#if defined(HW75_300_REV_2) || defined(HW75_300_REV_3)
// Permanent UART Peripheral (for NRF51)// UART2
...
//#endif
//#ifndef MCCONF_FOC_F_ZV//SW
//#define MCCONF_FOC_F_ZV					20000.0
//#endif
//#ifndef MCCONF_L_MAX_ABS_CURRENT
//#define MCCONF_L_MAX_ABS_CURRENT		1050.0	// The maximum absolute current above which a fault is generated
//#endif
...
// Setting limits
#define HW_LIM_CURRENT			-200.0, 100.0
#define HW_LIM_CURRENT_IN		-200.0, 100.0
#define HW_LIM_CURRENT_ABS		0.0, 350.0
#define HW_LIM_VIN				12.0, 100.0
