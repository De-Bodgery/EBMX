...
int32_t confgenerator_serialize_mcconf(uint8_t *buffer,
	...
	buffer_append_float32_auto(buffer,
			conf->sl_max_fullbreak_current_dir_change, &ind);
	...
	buffer_append_float32_auto(buffer, conf->foc_encoder_sincos_filter_constant,
			&ind);
	...
	buffer_append_float16(buffer, conf->foc_offsets_voltage_undriven[0], 10000,
			&ind);
	buffer_append_float16(buffer, conf->foc_offsets_voltage_undriven[1], 10000,
			&ind);
	buffer_append_float16(buffer, conf->foc_offsets_voltage_undriven[2], 10000,
			&ind);
...
int32_t confgenerator_serialize_appconf(uint8_t *buffer,
		const app_configuration *conf) {
	int32_t ind = 0;
	...
	buffer_append_float32_auto(buffer, conf->app_ppm_conf.throttle_exp_brake,
			&ind);
	...
	buffer_append_float32_auto(buffer, conf->app_ppm_conf.smart_rev_max_duty,
			&ind);
	buffer_append_float32_auto(buffer, conf->app_ppm_conf.smart_rev_ramp_time,
			&ind);
	...
	buffer_append_float32_auto(buffer, conf->app_adc_conf.throttle_exp_brake,
			&ind);
	...
	buffer_append_float32_auto(buffer,
			conf->app_chuk_conf.stick_erpm_per_s_in_cc, &ind);
	buffer_append_float32_auto(buffer, conf->app_chuk_conf.throttle_exp, &ind);
	buffer_append_float32_auto(buffer, conf->app_chuk_conf.throttle_exp_brake,
			&ind);
	...
	buffer_append_float32_auto(buffer, conf->app_chuk_conf.smart_rev_max_duty,
			&ind);
	buffer_append_float32_auto(buffer, conf->app_chuk_conf.smart_rev_ramp_time,
			&ind);
	...
	buffer_append_float32_auto(buffer, conf->app_balance_conf.fault_pitch,
			&ind);
	...
	buffer_append_uint16(buffer, conf->app_balance_conf.fault_delay_pitch,
			&ind);
	...
	buffer_append_uint16(buffer, conf->app_balance_conf.fault_delay_switch_half,
			&ind);
	buffer_append_uint16(buffer, conf->app_balance_conf.fault_delay_switch_full,
			&ind);
	buffer_append_uint16(buffer, conf->app_balance_conf.fault_adc_half_erpm,
			&ind);
	buffer_append_float16(buffer, conf->app_balance_conf.tiltback_duty_angle,
			100, &ind);
	buffer_append_float16(buffer, conf->app_balance_conf.tiltback_duty_speed,
			100, &ind);
	buffer_append_float16(buffer, conf->app_balance_conf.tiltback_duty, 1000,
			&ind);
	buffer_append_float16(buffer, conf->app_balance_conf.tiltback_hv_angle, 100,
			&ind);
	buffer_append_float16(buffer, conf->app_balance_conf.tiltback_hv_speed, 100,
			&ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.tiltback_hv,
			&ind);
	buffer_append_float16(buffer, conf->app_balance_conf.tiltback_lv_angle, 100,
			&ind);
	buffer_append_float16(buffer, conf->app_balance_conf.tiltback_lv_speed, 100,
			&ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.tiltback_lv,
			&ind);
	buffer_append_float16(buffer, conf->app_balance_conf.tiltback_return_speed,
			100, &ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.tiltback_constant,
			&ind);
	buffer_append_uint16(buffer, conf->app_balance_conf.tiltback_constant_erpm,
			&ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.tiltback_variable,
			&ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.tiltback_variable_max, &ind);
	buffer_append_float16(buffer, conf->app_balance_conf.noseangling_speed, 100,
			&ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.startup_pitch_tolerance, &ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.startup_roll_tolerance, &ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.startup_speed,
			&ind);
	...
	buffer_append_float32_auto(buffer, conf->app_balance_conf.roll_steer_kp,
			&ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.roll_steer_erpm_kp, &ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.brake_current,
			&ind);
	buffer_append_uint16(buffer, conf->app_balance_conf.brake_timeout, &ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.yaw_current_clamp,
			&ind);
	buffer_append_uint16(buffer,
			conf->app_balance_conf.kd_pt1_lowpass_frequency, &ind);
	buffer_append_uint16(buffer,
			conf->app_balance_conf.kd_pt1_highpass_frequency, &ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.kd_biquad_lowpass,
			&ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.kd_biquad_highpass, &ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.booster_angle,
			&ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.booster_ramp,
			&ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.booster_current,
			&ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.torquetilt_start_current, &ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.torquetilt_angle_limit, &ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.torquetilt_on_speed, &ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.torquetilt_off_speed, &ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.torquetilt_strength, &ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.torquetilt_filter,
			&ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.turntilt_strength,
			&ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.turntilt_angle_limit, &ind);
	buffer_append_float32_auto(buffer,
			conf->app_balance_conf.turntilt_start_angle, &ind);
	buffer_append_uint16(buffer, conf->app_balance_conf.turntilt_start_erpm,
			&ind);
	buffer_append_float32_auto(buffer, conf->app_balance_conf.turntilt_speed,
			&ind);
	buffer_append_uint16(buffer, conf->app_balance_conf.turntilt_erpm_boost,
			&ind);
	buffer_append_uint16(buffer, conf->app_balance_conf.turntilt_erpm_boost_end,
			&ind);
	buffer[ind++] = conf->app_pas_conf.ctrl_type;
	buffer[ind++] = conf->app_pas_conf.sensor_type;
	buffer_append_float16(buffer, conf->app_pas_conf.current_scaling, 1000,
			&ind);
	...
	buffer_append_float32_auto(buffer, conf->imu_conf.accel_confidence_decay,
			&ind);
...
bool confgenerator_deserialize_mcconf(const uint8_t *buffer,
	...
	conf->sl_max_fullbreak_current_dir_change = buffer_get_float32_auto(buffer,
			&ind);
	...
	conf->foc_encoder_sincos_filter_constant = buffer_get_float32_auto(buffer,
			&ind);
	...
	conf->foc_offsets_voltage_undriven[0] = buffer_get_float16(buffer, 10000,
			&ind);
	conf->foc_offsets_voltage_undriven[1] = buffer_get_float16(buffer, 10000,
			&ind);
	conf->foc_offsets_voltage_undriven[2] = buffer_get_float16(buffer, 10000,
			&ind);
...
bool confgenerator_deserialize_appconf(const uint8_t *buffer,
	...
	conf->app_ppm_conf.throttle_exp_brake = buffer_get_float32_auto(buffer,
			&ind);
	...
	conf->app_ppm_conf.smart_rev_max_duty = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_ppm_conf.smart_rev_ramp_time = buffer_get_float32_auto(buffer,
			&ind);
	...
	conf->app_adc_conf.throttle_exp_brake = buffer_get_float32_auto(buffer,
			&ind);
	...
	conf->app_chuk_conf.stick_erpm_per_s_in_cc = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_chuk_conf.throttle_exp = buffer_get_float32_auto(buffer, &ind);
	conf->app_chuk_conf.throttle_exp_brake = buffer_get_float32_auto(buffer,
			&ind);
	...
	conf->app_chuk_conf.smart_rev_max_duty = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_chuk_conf.smart_rev_ramp_time = buffer_get_float32_auto(buffer,
			&ind);
	...
	conf->app_balance_conf.fault_delay_switch_half = buffer_get_uint16(buffer,
			&ind);
	conf->app_balance_conf.fault_delay_switch_full = buffer_get_uint16(buffer,
			&ind);
	conf->app_balance_conf.fault_adc_half_erpm = buffer_get_uint16(buffer,
			&ind);
	conf->app_balance_conf.tiltback_duty_angle = buffer_get_float16(buffer, 100,
			&ind);
	conf->app_balance_conf.tiltback_duty_speed = buffer_get_float16(buffer, 100,
			&ind);
	conf->app_balance_conf.tiltback_duty = buffer_get_float16(buffer, 1000,
			&ind);
	conf->app_balance_conf.tiltback_hv_angle = buffer_get_float16(buffer, 100,
			&ind);
	conf->app_balance_conf.tiltback_hv_speed = buffer_get_float16(buffer, 100,
			&ind);
	conf->app_balance_conf.tiltback_hv = buffer_get_float32_auto(buffer, &ind);
	conf->app_balance_conf.tiltback_lv_angle = buffer_get_float16(buffer, 100,
			&ind);
	conf->app_balance_conf.tiltback_lv_speed = buffer_get_float16(buffer, 100,
			&ind);
	conf->app_balance_conf.tiltback_lv = buffer_get_float32_auto(buffer, &ind);
	conf->app_balance_conf.tiltback_return_speed = buffer_get_float16(buffer,
			100, &ind);
	conf->app_balance_conf.tiltback_constant = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.tiltback_constant_erpm = buffer_get_uint16(buffer,
			&ind);
	conf->app_balance_conf.tiltback_variable = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.tiltback_variable_max = buffer_get_float32_auto(
			buffer, &ind);
	conf->app_balance_conf.noseangling_speed = buffer_get_float16(buffer, 100,
			&ind);
	conf->app_balance_conf.startup_pitch_tolerance = buffer_get_float32_auto(
			buffer, &ind);
	conf->app_balance_conf.startup_roll_tolerance = buffer_get_float32_auto(
			buffer, &ind);
	conf->app_balance_conf.startup_speed = buffer_get_float32_auto(buffer,
			&ind);
	...
	conf->app_balance_conf.roll_steer_kp = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.roll_steer_erpm_kp = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.brake_current = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.brake_timeout = buffer_get_uint16(buffer, &ind);
	conf->app_balance_conf.yaw_current_clamp = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.kd_pt1_lowpass_frequency = buffer_get_uint16(buffer,
			&ind);
	conf->app_balance_conf.kd_pt1_highpass_frequency = buffer_get_uint16(buffer,
			&ind);
	conf->app_balance_conf.kd_biquad_lowpass = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.kd_biquad_highpass = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.booster_angle = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.booster_ramp = buffer_get_float32_auto(buffer, &ind);
	conf->app_balance_conf.booster_current = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.torquetilt_start_current = buffer_get_float32_auto(
			buffer, &ind);
	conf->app_balance_conf.torquetilt_angle_limit = buffer_get_float32_auto(
			buffer, &ind);
	conf->app_balance_conf.torquetilt_on_speed = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.torquetilt_off_speed = buffer_get_float32_auto(
			buffer, &ind);
	conf->app_balance_conf.torquetilt_strength = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.torquetilt_filter = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.turntilt_strength = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.turntilt_angle_limit = buffer_get_float32_auto(
			buffer, &ind);
	conf->app_balance_conf.turntilt_start_angle = buffer_get_float32_auto(
			buffer, &ind);
	conf->app_balance_conf.turntilt_start_erpm = buffer_get_uint16(buffer,
			&ind);
	conf->app_balance_conf.turntilt_speed = buffer_get_float32_auto(buffer,
			&ind);
	conf->app_balance_conf.turntilt_erpm_boost = buffer_get_uint16(buffer,
			&ind);
	conf->app_balance_conf.turntilt_erpm_boost_end = buffer_get_uint16(buffer,
			&ind);
	...
	motor_type = buffer[ind++];
	if (conf->imu_conf.mode != motor_type) {
		change = 1;
		conf->imu_conf.mode = motor_type;
	} else
		change = 0;
	//conf->imu_conf.mode =;
	conf->imu_conf.sample_rate_hz = buffer_get_uint16(buffer, &ind);
	conf->imu_conf.accel_confidence_decay = buffer_get_float32_auto(buffer,
			&ind);
...
void confgenerator_set_defaults_mcconf(mc_configuration *conf) {
	...
	MCCONF_SL_MAX_FB_CURR_DIR_CHANGE;
	...
	conf->foc_offsets_voltage_undriven[0] =
	MCCONF_FOC_OFFSETS_VOLTAGE_UNDRIVEN_0;
	conf->foc_offsets_voltage_undriven[1] =
	MCCONF_FOC_OFFSETS_VOLTAGE_UNDRIVEN_1;
	conf->foc_offsets_voltage_undriven[2] =
...
void talaria_confgenerator_set_defaults_mcconf(mc_configuration *conf) {
	conf->pwm_mode = MCCONF_PWM_MODE;
	conf->comm_mode = MCCONF_COMM_MODE;
	conf->motor_type = MCCONF_DEFAULT_MOTOR_TYPE;
	conf->sensor_mode = MCCONF_SENSOR_MODE;
	...
	conf->l_temp_fet_start = MCCONF_L_LIM_TEMP_FET_START;
	conf->l_temp_fet_end = MCCONF_L_LIM_TEMP_FET_END;
	conf->l_temp_motor_start = TMCCONF_L_LIM_TEMP_MOTOR_START;
	conf->l_temp_motor_end = TMCCONF_L_LIM_TEMP_MOTOR_END;
	conf->l_temp_accel_dec = MCCONF_L_LIM_TEMP_ACCEL_DEC;
	conf->l_min_duty = MCCONF_L_MIN_DUTY;
	conf->l_max_duty = MCCONF_L_MAX_DUTY;
	conf->l_watt_max = MCCONF_L_WATT_MAX;
	...
	conf->foc_encoder_cos_offset = MCCONF_FOC_ENCODER_COS_OFFSET;
	conf->foc_encoder_sincos_filter_constant = MCCONF_FOC_ENCODER_SINCOS_FILTER;
	conf->foc_sensor_mode = TMCCONF_FOC_SENSOR_MODE;
	conf->foc_pll_kp = MCCONF_FOC_PLL_KP;
	conf->foc_pll_ki = MCCONF_FOC_PLL_KI;
	conf->foc_motor_l = MCCONF_FOC_MOTOR_L;
	conf->foc_motor_ld_lq_diff = MCCONF_FOC_MOTOR_LD_LQ_DIFF;
	...
	conf->foc_hall_table[7] = MCCONF_FOC_HALL_TAB_7;
	conf->foc_hall_interp_erpm = MCCONF_FOC_HALL_INTERP_ERPM;
	conf->foc_sl_erpm = TMCCONF_FOC_SL_ERPM;
	conf->foc_sample_v0_v7 = MCCONF_FOC_SAMPLE_V0_V7;
	conf->foc_sample_high_current = MCCONF_FOC_SAMPLE_HIGH_CURRENT;
	conf->foc_sat_comp = MCCONF_FOC_SAT_COMP;
	conf->foc_temp_comp = MCCONF_FOC_TEMP_COMP;
	...
	conf->m_current_backoff_gain = MCCONF_M_CURRENT_BACKOFF_GAIN;
	conf->m_encoder_counts = MCCONF_M_ENCODER_COUNTS;
	conf->m_sensor_port_mode = TMCCONF_M_SENSOR_PORT_MODE;
	conf->m_invert_direction = TMCCONF_M_INVERT_DIRECTION;
	conf->m_drv8301_oc_mode = MCCONF_M_DRV8301_OC_MODE;
	conf->m_drv8301_oc_adj = MCCONF_M_DRV8301_OC_ADJ;
	conf->m_bldc_f_sw_min = MCCONF_M_BLDC_F_SW_MIN;
	conf->m_bldc_f_sw_max = MCCONF_M_BLDC_F_SW_MAX;
...
void kors_confgenerator_set_defaults_mcconf(mc_configuration *conf) {
	conf->pwm_mode = MCCONF_PWM_MODE;
	conf->comm_mode = MCCONF_COMM_MODE;
	conf->motor_type = MCCONF_DEFAULT_MOTOR_TYPE;
	conf->sensor_mode = MCCONF_SENSOR_MODE;
	...
	conf->l_temp_fet_start = MCCONF_L_LIM_TEMP_FET_START;
	conf->l_temp_fet_end = MCCONF_L_LIM_TEMP_FET_END;
	conf->l_temp_motor_start = KMCCONF_L_LIM_TEMP_MOTOR_START;
	conf->l_temp_motor_end = KMCCONF_L_LIM_TEMP_MOTOR_END;
	conf->l_temp_accel_dec = MCCONF_L_LIM_TEMP_ACCEL_DEC;
	conf->l_min_duty = MCCONF_L_MIN_DUTY;
	conf->l_max_duty = MCCONF_L_MAX_DUTY;
	conf->l_watt_max = MCCONF_L_WATT_MAX;
	...
	conf->hall_table[7] = MCCONF_HALL_TAB_7;
	conf->hall_sl_erpm = MCCONF_HALL_ERPM;
	conf->foc_current_kp = KMCCONF_FOC_CURRENT_KP;
	conf->foc_current_ki = KMCCONF_FOC_CURRENT_KI;
	conf->foc_f_zv = MCCONF_FOC_F_ZV;
	conf->foc_dt_us = MCCONF_FOC_DT_US;
	conf->foc_encoder_inverted = MCCONF_FOC_ENCODER_INVERTED;
	conf->foc_encoder_offset = MCCONF_FOC_ENCODER_OFFSET;
	...
	conf->foc_encoder_cos_offset = MCCONF_FOC_ENCODER_COS_OFFSET;
	conf->foc_encoder_sincos_filter_constant = MCCONF_FOC_ENCODER_SINCOS_FILTER;
	conf->foc_sensor_mode = KMCCONF_FOC_SENSOR_MODE;
	conf->foc_pll_kp = MCCONF_FOC_PLL_KP;
	conf->foc_pll_ki = MCCONF_FOC_PLL_KI;
	conf->foc_motor_l = KMCCONF_FOC_MOTOR_L;
	conf->foc_motor_ld_lq_diff = KMCCONF_FOC_MOTOR_LD_LQ_DIFF;
	conf->foc_motor_r = KMCCONF_FOC_MOTOR_R;
	conf->foc_motor_flux_linkage = KMCCONF_FOC_MOTOR_FLUX_LINKAGE;
	conf->foc_observer_gain = MCCONF_FOC_OBSERVER_GAIN;
	conf->foc_observer_gain_slow = KMCCONF_FOC_OBSERVER_GAIN_SLOW;
	conf->foc_observer_offset = KMCCONF_FOC_OBSERVER_OFFSET;
	conf->foc_duty_dowmramp_kp = MCCONF_FOC_DUTY_DOWNRAMP_KP;
	conf->foc_duty_dowmramp_ki = MCCONF_FOC_DUTY_DOWNRAMP_KI;
	conf->foc_openloop_rpm = KMCCONF_FOC_OPENLOOP_RPM;
	conf->foc_openloop_rpm_low = MCCONF_FOC_OPENLOOP_RPM_LOW;
	conf->foc_d_gain_scale_start = MCCONF_FOC_D_GAIN_SCALE_START;
	conf->foc_d_gain_scale_max_mod = MCCONF_FOC_D_GAIN_SCALE_MAX_MOD;
	conf->foc_sl_openloop_hyst = MCCONF_FOC_SL_OPENLOOP_HYST;
	...
	conf->foc_sl_openloop_time_ramp = MCCONF_FOC_SL_OPENLOOP_T_RAMP;
	conf->foc_sl_openloop_time = MCCONF_FOC_SL_OPENLOOP_TIME;
	conf->foc_hall_table[0] = KMCCONF_FOC_HALL_TAB_0;
	conf->foc_hall_table[1] = KMCCONF_FOC_HALL_TAB_1;
	conf->foc_hall_table[2] = KMCCONF_FOC_HALL_TAB_2;
	conf->foc_hall_table[3] = KMCCONF_FOC_HALL_TAB_3;
	conf->foc_hall_table[4] = KMCCONF_FOC_HALL_TAB_4;
	conf->foc_hall_table[5] = KMCCONF_FOC_HALL_TAB_5;
	conf->foc_hall_table[6] = KMCCONF_FOC_HALL_TAB_6;
	conf->foc_hall_table[7] = KMCCONF_FOC_HALL_TAB_7;
	conf->foc_hall_interp_erpm = KMCCONF_FOC_HALL_INTERP_ERPM;
	conf->foc_sl_erpm = KMCCONF_FOC_SL_ERPM;
	conf->foc_sample_v0_v7 = MCCONF_FOC_SAMPLE_V0_V7;
	conf->foc_sample_high_current = MCCONF_FOC_SAMPLE_HIGH_CURRENT;
	conf->foc_sat_comp = KMCCONF_FOC_SAT_COMP;
	conf->foc_temp_comp = MCCONF_FOC_TEMP_COMP;
	conf->foc_temp_comp_base_temp = MCCONF_FOC_TEMP_COMP_BASE_TEMP;
	conf->foc_current_filter_const = MCCONF_FOC_CURRENT_FILTER_CONST;
	conf->foc_cc_decoupling = MCCONF_FOC_CC_DECOUPLING;
	...
	conf->foc_phase_filter_enable = MCCONF_FOC_PHASE_FILTER_ENABLE;
	conf->foc_phase_filter_max_erpm = MCCONF_FOC_PHASE_FILTER_MAX_ERPM;
	conf->foc_mtpa_mode = KMCCONF_FOC_MTPA_MODE;
	conf->foc_fw_current_max = MCCONF_FOC_FW_CURRENT_MAX;
	conf->foc_fw_duty_start = KMCCONF_FOC_FW_DUTY_START;
	conf->foc_fw_ramp_time = KMCCONF_FOC_FW_RAMP_TIME;
	conf->foc_fw_q_current_factor = KMCCONF_FOC_FW_Q_CURRENT_FACTOR;
	conf->gpd_buffer_notify_left = MCCONF_GPD_BUFFER_NOTIFY_LEFT;
	conf->gpd_buffer_interpol = MCCONF_GPD_BUFFER_INTERPOL;
	conf->gpd_current_filter_const = MCCONF_GPD_CURRENT_FILTER_CONST;
	conf->gpd_current_kp = MCCONF_GPD_CURRENT_KP;
	...
	conf->m_current_backoff_gain = MCCONF_M_CURRENT_BACKOFF_GAIN;
	conf->m_encoder_counts = MCCONF_M_ENCODER_COUNTS;
	conf->m_sensor_port_mode = KMCCONF_M_SENSOR_PORT_MODE;
	conf->m_invert_direction = KMCCONF_M_INVERT_DIRECTION;
	conf->m_drv8301_oc_mode = MCCONF_M_DRV8301_OC_MODE;
	conf->m_drv8301_oc_adj = MCCONF_M_DRV8301_OC_ADJ;
	conf->m_bldc_f_sw_min = MCCONF_M_BLDC_F_SW_MIN;
	conf->m_bldc_f_sw_max = MCCONF_M_BLDC_F_SW_MAX;
	...
	conf->m_ntc_motor_beta = MCCONF_M_NTC_MOTOR_BETA;
	conf->m_out_aux_mode = MCCONF_M_OUT_AUX_MODE;
	conf->m_motor_temp_sens_type = KMCCONF_M_MOTOR_TEMP_SENS_TYPE;
	conf->m_ptc_motor_coeff = MCCONF_M_PTC_MOTOR_COEFF;
	conf->m_hall_extra_samples = MCCONF_M_HALL_EXTRA_SAMPLES;
	conf->si_motor_poles = KMCCONF_SI_MOTOR_POLES;
	conf->si_gear_ratio = MCCONF_SI_GEAR_RATIO;
	conf->si_wheel_diameter = MCCONF_SI_WHEEL_DIAMETER;
	conf->si_battery_type = MCCONF_SI_BATTERY_TYPE;
	conf->si_battery_cells = MCCONF_SI_BATTERY_CELLS;
	conf->si_battery_ah = MCCONF_SI_BATTERY_AH;
	conf->si_motor_nl_current = KMCCONF_SI_MOTOR_NL_CURRENT;
	conf->bms.type = MCCONF_BMS_TYPE;
	conf->bms.t_limit_start = MCCONF_BMS_T_LIMIT_START;
	conf->bms.t_limit_end = MCCONF_BMS_T_LIMIT_END;
	conf->bms.soc_limit_start = MCCONF_BMS_SOC_LIMIT_START;
...
void confgenerator_set_defaults_appconf(app_configuration *conf) {
	...
	conf->servo_out_enable = MCCONF_M_INVERT_DIRECTION;
	...
	conf->app_balance_conf.fault_delay_pitch =
	...
	conf->app_balance_conf.fault_delay_switch_half =
	APPCONF_BALANCE_FAULT_DELAY_SWITCH_HALF;
	conf->app_balance_conf.fault_delay_switch_full =
	APPCONF_BALANCE_FAULT_DELAY_SWITCH_FULL;
	conf->app_balance_conf.fault_adc_half_erpm =
	APPCONF_BALANCE_FAULT_ADC_HALF_ERPM;
	conf->app_balance_conf.tiltback_duty_angle =
	APPCONF_BALANCE_TILTBACK_DUTY_ANGLE;
	conf->app_balance_conf.tiltback_duty_speed =
	APPCONF_BALANCE_TILTBACK_DUTY_SPEED;
	conf->app_balance_conf.tiltback_duty = APPCONF_BALANCE_TILTBACK_DUTY;
	conf->app_balance_conf.tiltback_hv_angle =
	APPCONF_BALANCE_TILTBACK_HV_ANGLE;
	conf->app_balance_conf.tiltback_hv_speed =
	APPCONF_BALANCE_TILTBACK_HV_SPEED;
	conf->app_balance_conf.tiltback_hv = APPCONF_BALANCE_TILTBACK_HV;
	conf->app_balance_conf.tiltback_lv_angle =
	APPCONF_BALANCE_TILTBACK_LV_ANGLE;
	conf->app_balance_conf.tiltback_lv_speed =
	APPCONF_BALANCE_TILTBACK_LV_SPEED;
	conf->app_balance_conf.tiltback_lv = APPCONF_BALANCE_TILTBACK_LV;
	conf->app_balance_conf.tiltback_return_speed =
	APPCONF_BALANCE_TILTBACK_RETURN_SPEED;
	conf->app_balance_conf.tiltback_constant =
	APPCONF_BALANCE_TILTBACK_CONSTANT;
	conf->app_balance_conf.tiltback_constant_erpm =
	APPCONF_BALANCE_TILTBACK_CONSTANT_ERPM;
	conf->app_balance_conf.tiltback_variable =
	APPCONF_BALANCE_TILTBACK_VARIABLE;
	conf->app_balance_conf.tiltback_variable_max =
	APPCONF_BALANCE_TILTBACK_VARIABLE_MAX;
	conf->app_balance_conf.noseangling_speed =
	APPCONF_BALANCE_NOSEANGLING_SPEED;
	conf->app_balance_conf.startup_pitch_tolerance =
	APPCONF_BALANCE_STARTUP_PITCH_TOLERANCE;
	conf->app_balance_conf.startup_roll_tolerance =
	...
	conf->app_balance_conf.roll_steer_erpm_kp =
	...
	conf->app_balance_conf.yaw_current_clamp =
	APPCONF_BALANCE_YAW_CURRENT_CLAMP;
	conf->app_balance_conf.kd_pt1_lowpass_frequency =
	APPCONF_BALANCE_KD_PT1_LOWPASS_FREQUENCY;
	conf->app_balance_conf.kd_pt1_highpass_frequency =
	APPCONF_BALANCE_KD_PT1_HIGHPASS_FREQUENCY;
	conf->app_balance_conf.kd_biquad_lowpass =
	APPCONF_BALANCE_KD_BIQUAD_LOWPASS;
	conf->app_balance_conf.kd_biquad_highpass =
	APPCONF_BALANCE_KD_BIQUAD_HIGHPASS;
	...
	conf->app_balance_conf.torquetilt_start_current =
	APPCONF_BALANCE_TORQUETILT_START_CURRENT;
	conf->app_balance_conf.torquetilt_angle_limit =
	APPCONF_BALANCE_TORQUETILT_ANGLE_LIMIT;
	conf->app_balance_conf.torquetilt_on_speed =
	APPCONF_BALANCE_TORQUETILT_ON_SPEED;
	conf->app_balance_conf.torquetilt_off_speed =
	APPCONF_BALANCE_TORQUETILT_OFF_SPEED;
	conf->app_balance_conf.torquetilt_strength =
	APPCONF_BALANCE_TORQUETILT_STRENGTH;
	conf->app_balance_conf.torquetilt_filter =
	APPCONF_BALANCE_TORQUETILT_FILTER;
	conf->app_balance_conf.turntilt_strength =
	APPCONF_BALANCE_TURNTILT_STRENGTH;
	conf->app_balance_conf.turntilt_angle_limit =
	APPCONF_BALANCE_TURNTILT_ANGLE_LIMIT;
	conf->app_balance_conf.turntilt_start_angle =
	APPCONF_BALANCE_TURNTILT_START_ANGLE;
	conf->app_balance_conf.turntilt_start_erpm =
	APPCONF_BALANCE_TURNTILT_START_ERPM;
	conf->app_balance_conf.turntilt_speed = APPCONF_BALANCE_TURNTILT_SPEED;
	conf->app_balance_conf.turntilt_erpm_boost =
	APPCONF_BALANCE_TURNTILT_ERPM_BOOST;
	conf->app_balance_conf.turntilt_erpm_boost_end =
	APPCONF_BALANCE_TURNTILT_ERPM_BOOST_END;
	...
	conf->app_pas_conf.invert_pedal_direction =
...
void talaria_confgenerator_set_defaults_appconf(app_configuration *conf) {
	conf->controller_id = HW_DEFAULT_ID;
	conf->timeout_msec = APPCONF_TIMEOUT_MSEC;
	conf->timeout_brake_current = APPCONF_TIMEOUT_BRAKE_CURRENT;
	conf->send_can_status = APPCONF_SEND_CAN_STATUS;
	conf->send_can_status_rate_hz = APPCONF_SEND_CAN_STATUS_RATE_HZ;
	conf->can_baud_rate = TAPPCONF_CAN_BAUD_RATE;
	conf->pairing_done = APPCONF_PAIRING_DONE;
	conf->permanent_uart_enabled = APPCONF_PERMANENT_UART_ENABLED;
	conf->shutdown_mode = APPCONF_SHUTDOWN_MODE;
	conf->can_mode = APPCONF_CAN_MODE;
	...
	conf->uavcan_raw_mode = APPCONF_UAVCAN_RAW_MODE;
	conf->uavcan_raw_rpm_max = APPCONF_UAVCAN_RAW_RPM_MAX;
	conf->servo_out_enable = TMCCONF_M_INVERT_DIRECTION;
	conf->kill_sw_mode = APPCONF_KILL_SW_MODE;
	conf->app_to_use = APPCONF_APP_TO_USE;
	conf->app_ppm_conf.ctrl_type = APPCONF_PPM_CTRL_TYPE;
	conf->app_ppm_conf.pid_max_erpm = APPCONF_PPM_PID_MAX_ERPM;
